...
# Database configuration for development using environment variables
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': config('DB_NAME', default='voiceappoint'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'VoiceAppoint API',
    'DESCRIPTION': 'API for VoiceAppoint appointment booking system',
    'VERSION': '1.0.0',
...
DEFAULT_FROM_EMAIL = config('FROM_EMAIL', default='noreply@voiceappoint.local')
